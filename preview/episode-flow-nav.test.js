...
assert.equal(
  ...
  "caption quality glossary fix links carry cleanup entry context",
);
assert.equal(
  ...
  "caption quality cross-talk fix links carry cleanup entry context",
);
assert.equal(
...
assert.equal(
  ...
  "embedded caption quality glossary fix links route through the preview app with cleanup context",
);
assert.equal(
  ...
  "embedded caption quality cross-talk fix links route through the preview app with cleanup context",
);
assert.equal(
