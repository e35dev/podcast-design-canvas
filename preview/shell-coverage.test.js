...
assert.match(shell, /Choose a starting layout/, "shell shows a starting layout picker");
assert.match(shell, /Interview split/, "shell offers an interview layout");
assert.match(shell, /Solo spotlight/, "shell offers a solo layout");
