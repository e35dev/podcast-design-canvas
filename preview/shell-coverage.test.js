...
assert.match(shell, /Starting layout options/, "shell exposes layout choices before placement");
assert.match(shell, /Use solo spotlight/, "shell offers a solo canvas composition");
assert.match(shell, /Use panel grid/, "shell offers a panel canvas composition");
...
assert.match(shell, /Guest 2 video slot/, "shell includes the panel-only second guest slot");
...
assert.match(shell, /data-slot="guest-b"/, "shell labels the second guest slot for panel placement");
assert.match(shell, /data-file-input="guest-b"/, "shell lets the panel-only second guest slot accept a real uploaded video");
